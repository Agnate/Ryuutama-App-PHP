<?php
/**
 * This script updates the database to the specified version.
 * Example of updating to version 0.2.0:
 * 
 * (from  /var/www/dinelle.ca  directory)
...
$version_db_table_name = 'update_version';
$path_to_updates = SERVER_ROOT.'/bin/updates';
